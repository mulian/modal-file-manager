ModalFileManager = require '../lib/modal-file-manager'
...
describe "ModalFileManager", ->
  ...
  describe "when the modal-file-manager:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      # has been created
      expect(workspaceElement.querySelector('.modal-file-manager')).not.toExist()
      ...
      runs ->
        expect(workspaceElement.querySelector('.modal-file-manager')).toExist()

        modalFileManagerElement = workspaceElement.querySelector('.modal-file-manager')
        expect(modalFileManagerElement).toExist()
